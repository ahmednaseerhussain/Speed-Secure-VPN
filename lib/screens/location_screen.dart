  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
        ...
        appBar: AppBar(automaticallyImplyLeading: true,foregroundColor: Colors.white,
          backgroundColor:  Color(0xff13152a),
          title: Text('VPN Locations (${_controller.vpnList.length})',style: TextStyle(color: Colors.white),),
        ),
